 ...
 */
declare const actOnDefault: <H extends HookContext = HookContext<_feathersjs_feathers.Application<any, any>, any>>(...hooks: HookFunction<H>[]) => (context: H) => Promise<H>;
/**
 * Runs a series of hooks which mutate context.dispatch.
 * @see https://hooks-common.feathersjs.com/hooks.html#actondispatch
 */
declare const actOnDispatch: <H extends HookContext = HookContext<_feathersjs_feathers.Application<any, any>, any>>(...hooks: HookFunction<H>[]) => (context: H) => Promise<H>;
